...
def main():
    ...
    with col1:
        ...
        def stpv_usage_example(number_floors: int, dummy: str = "cube") -> pv.Plotter:
            ...
            house_base = house_base.triangulate()  # Triangulate the cube mesh
        
            # Adding a door as a thin box
            door = pv.Box(bounds=(-0.4, 0.4, -1, -0.8, 0, 0.8))
            door.translate((0, 0, 0.4))
            door = door.triangulate()  # Triangulate the door mesh
            ...
            window = window.triangulate()  # Triangulate the window mesh
            ...
            # ... Roof creation code remains the same ...
